...
, buy_side as (
	...
	((buy_price - external_price)/(buy_price + external_price)/2) * 100 as price_difference,
...
, sell_side as (
	...
	((sell_price - external_price)/(sell_price + external_price)/2) * 100 as price_difference,
